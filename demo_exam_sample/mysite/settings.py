...
SECRET_KEY = 'django-insecure-5y#s1h-#)075q^4c_h_k&3cfq_mfa+&axyyb$&3e-1lq=68wut'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql', # заменяем sqlite3 на postgresql
        'NAME': 'check', # Имя базы данных
